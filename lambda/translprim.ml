...
let lambda_primitive_needs_event_after = function
  ...
  | Pgetglobal _ | Pmakeblock _ | Pmakeflatblock _ | Pfield _ | Pfield_computed
  | Psetfield _ | Psetfield_computed _ | Pflatfield _ | Psetflatfield _
  | Pfloatfield _ | Psetfloatfield _ | Praise _
